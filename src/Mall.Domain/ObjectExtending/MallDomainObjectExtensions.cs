...
namespace Mall.ObjectExtending
{
    public static class MallDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the MallEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
